...
const auto kTestTasksList =
    std::tuple_cat(ppc::util::AddFuncTask<BarkalovaMStarMPI, InType>(kTestParam, PPC_SETTINGS_example_processes_2),
                   ppc::util::AddFuncTask<BarkalovaMStarSEQ, InType>(kTestParam, PPC_SETTINGS_example_processes_2));
